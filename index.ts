...
const server = new MCPServer({
  name: "mcp-use-doom",
  title: "mcp-use-doom", // Human readable name of the server
  version: "1.0.0",
...
export const showApp = server.tool(
  {
    ...
    title: "Doom in an iframe", // Short label in inspector and client UIs (falls back to name).
    description: "Display  Doom in an iframe. Only works in mcp-use playground, not real host because of the nested iframe.", // LLM-facing summary of what the tool does.
...
export const doomCSS = server.tool(
  {
    name: "doom-css", // Unique tool id on the wire.
    title: "Doom implemented in CSS", // Short label in inspector and client UIs (falls back to name).
    description: "Display Doom game, using cssDOOM open source implementation (https://github.com/NielsLeenheer/cssDOOM).", // LLM-facing summary of what the tool does.
    ...
    view: {
      name: "doom-css", // directory under views/
